...
export const mdxComponents = {
  ...
  h4: ({ className, ...props }) => (
    <h4 className={cn("text-lg font-medium tracking-[-0.04em] text-foreground", className)} {...props} />
  ),
  p: ({ className, ...props }) => (
  ...
  a: MdxLink,
  ul: ({ className, ...props }) => (
    <ul className={cn("space-y-3 pl-6 text-[0.98rem] leading-8 text-foreground/72", className)} {...props} />
  ),
  ol: ({ className, ...props }) => (
    <ol className={cn("space-y-3 pl-6 text-[0.98rem] leading-8 text-foreground/72", className)} {...props} />
  ),
  ...
  td: ({ className, ...props }) => (
    <td className={cn("border-t border-border/60 px-4 py-3 align-top text-foreground/68", className)} {...props} />
  ),
