...
</html>`)})});if(!c.ok)throw Error(`Resend API error: ${c.status}`)}catch{return{status:"error",message:"The message could not be delivered right now. Please try again or email us directly.",errors:{},values:e}}return{status:"success",message:"Thanks. We sent a confirmation email and will reply with a thoughtful next step.",errors:{},values:c}}(0,a.i(13095).ensureServerEntryExports)([e]),(0,b.registerServerReference)(e,"6001509d8296da45c377ed5a70f289b8cfb55875a6",null),a.s([],12581),a.i(12581),a.s(["6001509d8296da45c377ed5a70f289b8cfb55875a6",0,e],27797)}];
