...
export const capabilities = [
  {
    ...
    description:
      "Modern product systems with clear architecture and long-term composure.",
  },
  {
    title: "Platform foundations",
    description:
      "Web platforms, shared tooling, and foundations that reduce drag for teams.",
  },
  {
    title: "Open-source tooling",
    description:
      "Public packages and reusable building blocks that compound over time.",
  },
];
...
export const serviceAreas = [
  {
    ...
    description:
      "Purpose-built systems with sober choices and clear boundaries.",
    bullets: ["App Router and modern web stacks", "Type-safe APIs", "Incremental delivery"],
  },
  {
    title: "Web platforms",
    description:
      "Marketing sites and application shells aligned with product goals.",
    bullets: ["Design-aware implementation", "Performance budgets", "Accessibility by default"],
  },
  {
    title: "Design systems",
    description:
      "Reusable UI systems with careful tokens and operational clarity.",
    bullets: ["Token strategy", "Composable primitives", "Visual consistency"],
  },
  {
    title: "Technical architecture",
    description:
      "Rendering, runtime, and delivery decisions that keep systems coherent.",
    bullets: ["Cloudflare-ready deployments", "Boundary setting", "Runtime pragmatism"],
  },
  {
    title: "Performance optimization",
    description:
      "Measured improvements to loading, rendering, and interaction quality.",
    bullets: ["Core Web Vitals", "Network efficiency", "Asset strategy"],
  },
  {
    title: "Developer experience",
    description:
      "Tooling and workflows that reduce rework and keep codebases easier to operate.",
...
export const operatingModel = [
  {
    ...
    description:
      "The people shaping the system stay close to the decisions that matter.",
  },
  {
    title: "Transparent tradeoffs",
    description:
      "Constraints are named early and tradeoffs stay visible.",
  },
  {
    title: "Long-term structure",
    description:
      "Architecture and handoff quality are treated as part of the product.",
  },
];
...
export const openSourceProjects = [
  {
    ...
    summary:
      "Reusable UI and layout patterns extracted from real delivery work.",
    tags: ["UI foundations", "Accessibility", "Design tokens"],
  },
  {
    name: "Workflow utilities",
    summary:
      "Checks, generators, and environment helpers that make workflows easier to read.",
    tags: ["DX", "Automation", "Release hygiene"],
  },
  {
    name: "Cloud-native starters",
    summary:
      "Composable starters for teams shipping on modern edge runtimes.",
...
export const contactFaq = [
  {
    ...
    answer:
      "Teams where product quality and engineering quality need to move together.",
  },
  {
    question: "Do you only work on open-source projects?",
    answer:
      "No. Open source is part of the approach, not a limit on the work.",
  },
  {
    question: "What helps a first conversation go well?",
    answer:
      "A short brief: current state, pressure points, and what success looks like next.",
  },
];
